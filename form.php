...
<form  action="thanks.php"  method="POST">
    <div>
      ...
      <input  type="text"  id="lastname"  name="user_lastname" value="" maxlength="80" required>
    </div>
    <div>
      <label  for="firstname">Prénom :</label>
      <input  type="text"  id="fistname"  name="user_firstname"  value=""  maxlength="80" required>
    </div>
    <div>
      <label  for="email">Courriel :</label>
        <input  type="email"  id="email"  name="user_email"  value="" required pattern="[^\s@]+@[^\s@]+\.[^\s@]+">
    </div>
    <div>
      <label  for="phone">Téléphone :</label>
        <input  type="phone"  id="phone"  name="user_phone"  value="" required>
    </div>
    <div>
    ...
    <div>
      ...
      <textarea  id="message"  name="user_message" value="" minlenth="3" required></textarea>
    </div>
    <div  class="button">
